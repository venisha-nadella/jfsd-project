        ...
        <div class="navbar-menu">
            ...
            <div class="navbar-item has-dropdown">
                ...
                <div class="dropdown-menu">
                    <a href="<%= request.getContextPath() %>/mentor/dashboard" class="dropdown-item">Main Dashboard</a>
                </div>
            </div>

            <!-- Mentor Settings Dropdown -->
            <div class="navbar-item has-dropdown">
                <a href="#" class="navbar-link">Mentor Settings</a>
                <div class="dropdown-menu">
            ...
            <div class="navbar-item has-dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a href="<%= request.getContextPath() %>/mentor/manage-courses" class="dropdown-item">Manage Courses</a>
                </div>
            </div>
